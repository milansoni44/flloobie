...
class Auth extends CI_Controller {
	...
	function login()
	{
		...
		if ($this->form_validation->run() == true)
		{
			...
			if ($this->ion_auth->login($this->input->post('identity'), $this->input->post('password'), $remember))
			{
                ...
                $login_activity = $this->ion_auth->insert_login_activity($this->input->post('identity'));
	...
	function create_user()
    {
        ...
        /* this is comment for front end user */
        // if (!$this->ion_auth->logged_in() || !$this->ion_auth->is_admin())
        // {
            // redirect('auth', 'refresh');
        // }
        ...
        $this->form_validation->set_rules('phone', $this->lang->line('create_user_validation_phone_label'), 'trim|required|xss_clean');
        ...
        if ($this->form_validation->run() == true)
        {
            if($_FILES['image']['size'] > 0)
            {
                ...
                $file_name = $this->input->post('first_name').".".$ext;
        ...
        else
        {
            ...
            $this->data['pincode'] = array(
                'name'          => 'pincode',
                'id'            => 'pincode',
                'type'          => 'text',
                'class'         => 'form-control',
                'placeholder'   => 'Pincode',
                'value'         => $this->form_validation->set_value('pincode'),
            );
            ...
            $this->data['states'] = $this->ion_auth->getStates();
            $this->data['cities'] = $this->ion_auth->getCities();
	...
	function _render_page($view, $data=null, $returnhtml=false)//I think this makes more sense
	{
		...
		$view_html = $this->template->build($view, $this->viewdata, $returnhtml);
    ...
    {
        if ($this->ion_auth->verifyEmailID($hash))
        {
