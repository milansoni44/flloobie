    <div class="contentpanel">
        <div class="panel panel-default">
            ...
            ?>
            <?php echo form_open_multipart('aboutus/about/'.$id,'class="form-horizontal form-bordered"'); ?>
                <div class="panel panel-default">
                        ...
                        <div class="form-group">
                            <?php echo form_label('Content','content',array('class'=>'col-sm-3 control-label')); ?>
                            <div class="col-sm-8">
