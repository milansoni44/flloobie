          ...
          <div class="panel panel-success panel-stat">
            <div class="panel-heading">
              ...
              <div class="stat">
                <div class="row">
                  <div class="col-xs-4">
                    <img src="<?php echo base_url();?>../themes/admin/images/is-user.png" alt="" />
                  </div>
                  <div class="col-xs-8">
                    <small class="stat-label">No. Users</small>
                    <h1><?php echo $no_user->no; ?></h1>
                  </div>
                </div><!-- row -->
          ...
          <div class="panel panel-danger panel-stat">
            <div class="panel-heading">
              ...
              <div class="stat">
                <div class="row">
                  <div class="col-xs-4">
                    <img src="<?php echo base_url();?>../themes/admin/images/is-document.png" alt="" />
                  </div>
                  <div class="col-xs-8">
                    <small class="stat-label">No. Listings</small>
                    <h1><?php echo $no_listing->number_listing; ?></h1>
                  </div>
                </div><!-- row -->
            ...
            <div class="panel-heading">
              ...
              <div class="stat">
                <div class="row">
                  ...
                  <div class="col-xs-8">
                    <small class="stat-label">Todays Logged In</small>
                    <h1><?php echo $logged_in->logged_in; ?></h1>
                  </div>
                </div><!-- row -->
          ...
          <div class="panel panel-dark panel-stat">
            <div class="panel-heading">
              ...
              <div class="stat">
                <div class="row">
                  <div class="col-xs-4">
                    <img src="<?php echo base_url();?>../themes/admin/images/is-money.png" alt="" />
                  </div>
                  <div class="col-xs-8">
        ...
        <div class="col-sm-12">
          ...
          <div class="table-responsive dashboard-datatable">
            <table class="table" id="table2">
              ...
              <tbody>
                <?php
                    if(!empty($today_listings)){
                        foreach($today_listings as $rw){
                ?>
                <tr class="odd gradeX">
                    <td><?php echo $rw->category_name; ?></td>
                    <td><?php echo $rw->listing_name; ?></td>
                    <td width="30%"><img src="<?php echo base_url();?>../themes/front/uploads/listing/<?php echo $rw->listing_image; ?>" width="15%"/></td>
                    <td><?php echo $rw->views; ?></td>
                </tr>
                <?php
                        }
                    }
      ...
      <div class="row">
        <div class="col-sm-6 col-md-4">
          <div class="panel panel-default widget-photoday">
            <div class="panel-body">
              <a href="#" class="photoday"><img src="<?php echo base_url();?>../themes/admin/images/photos/photo1.png" alt="" /></a>
        ...
        <div class="tab-pane active" id="rp-alluser">
            ...
            <ul class="chatuserlist">
                <li class="online">
                    <div class="media">
                        <a href="#" class="pull-left media-thumb">
                            <img alt="" src="<?php echo base_url();?>../themes/admin/images/photos/userprofile.png" class="media-object">
                        </a>
                ...
                <li class="online">
                    <div class="media">
                        <a href="#" class="pull-left media-thumb">
                            <img alt="" src="<?php echo base_url();?>../themes/admin/images/photos/user1.png" class="media-object">
                        </a>
                        <div class="media-body">
                ...
                <li class="online">
                    <div class="media">
                        <a href="#" class="pull-left media-thumb">
                            <img alt="" src="<?php echo base_url();?>../themes/admin/images/photos/user2.png" class="media-object">
                        </a>
                        <div class="media-body">
                ...
                <li class="online">
                    <div class="media">
                        <a href="#" class="pull-left media-thumb">
                            <img alt="" src="<?php echo base_url();?>../themes/admin/images/photos/user3.png" class="media-object">
                        </a>
                        <div class="media-body">
                ...
                <li class="online">
                    <div class="media">
                        <a href="#" class="pull-left media-thumb">
                            <img alt="" src="<?php echo base_url();?>../themes/admin/images/photos/user4.png" class="media-object">
                        </a>
                        <div class="media-body">
            ...
            <ul class="chatuserlist">
                <li>
                    <div class="media">
                        <a href="#" class="pull-left media-thumb">
                            <img alt="" src="<?php echo base_url();?>../themes/admin/images/photos/user5.png" class="media-object">
                        </a>
                        <div class="media-body">
                            <strong>Eileen Sideways</strong>
                            <small>Los Angeles, CA</small>
