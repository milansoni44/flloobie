    <?php
        $blog_name = array(
            ...
            'class'         => 'form-control',
            'value'         => $this->form_validation->set_value('blog_name',$blog->blog_name),
        );
        ...
        $blog_content = array(
            ...
            'value'     => $this->form_validation->set_value('blog_content',$blog->blog_content),
        );
        $blog_keywords = array(
            'name'          => 'blog_keywords',
            'id'            => 'blog_keywords',
            ...
            'value'         => $this->form_validation->set_value('blog_keywords',$blog->blog_keywords),
        );
        $blog_featured_img = array(
            'name'          => 'blog_featured_img',
            'type'          => 'hidden',
            'value'         => $blog->blog_featured_image,
        );
    ?>
    <div class="contentpanel">
        <div class="panel panel-default">
            ...
            ?>
            <?php echo form_open_multipart('blog/edit/'.$id,'class="form-horizontal form-bordered"'); ?>
                <div class="panel panel-default">
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                ...
                                ?>
                                <?php echo form_dropdown('blog_category',$option,$blog->blog_category_id,'class="form-control" id="blog_category" style="width:50%"'); ?>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <?php echo form_input($blog_featured_img); ?>
